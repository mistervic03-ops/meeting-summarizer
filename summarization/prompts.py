...
- Markdown 취소선 문법 "~~...~~"를 사용하지 마세요.
- 값을 고쳐 쓰는 과정의 self-correction/editing artifact를 출력하지 마세요.
- 수치나 값을 정정해야 한다면 이전 값과 수정 값을 나란히 남기지 말고 최종 의도 값만 쓰세요.
- 정상적인 범위 표기는 허용됩니다. 예: "93~95%", "10~15개", "5-7일"
...
Markdown 취소선 문법 "~~...~~"를 사용하지 말고, 값 수정 흔적이나 self-correction/editing artifact를 남기지 마세요.
수치나 값을 정정해야 한다면 이전 값과 수정 값을 함께 쓰지 말고 최종 의도 값만 작성하세요.
"93~95%", "10~15개", "5-7일" 같은 정상적인 범위 표기는 허용됩니다.
